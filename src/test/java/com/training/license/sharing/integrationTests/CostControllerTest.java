...
@Sql(value = {"/create-cost.sql"}, executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
@Sql(value = {"/delete-cost.sql"}, executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD)
